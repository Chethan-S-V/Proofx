      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_22rem]">
        <div className="space-y-6">
          <Card className="border-slate-800 bg-slate-950 p-5">
            <SettingsHeader
              description="Your sign-in identity is protected. Profile details can still be edited from your profile page."
              icon={UserRound}
              title="Account"
            />
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <label className="space-y-2">
                ...
                <input className={`${inputClass} cursor-not-allowed opacity-75`} disabled value={settings.email} type="email" />
                <span className="block text-xs text-slate-600">Your verified sign-in email cannot be changed here.</span>
              </label>
              <label className="space-y-2">
                <span className={labelClass}>Language</span>
                <input className={`${inputClass} cursor-not-allowed opacity-75`} disabled value="English" />
                <span className="block text-xs text-slate-600">ProofX currently uses English across the product.</span>
              </label>
            </div>
          </Card>
        ...
        <aside className="space-y-6">
          ...
          <Card className="border-slate-800 bg-slate-950 p-5">
            ...
            <div className="mt-5 space-y-3 text-sm leading-6 text-slate-400">
              ...
              <p>Your verified sign-in email is fixed and cannot be edited from settings.</p>
