      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_22rem]">
        <div className="space-y-6">
          <Card className="border-slate-800 bg-slate-950 p-5">
            <SettingsHeader
              description="These fields drive your header name, profile identity, language, and timezone."
              icon={UserRound}
              title="Account"
            />
            <form action={updateAccountSettings} className="mt-5 grid gap-4 sm:grid-cols-2">
              <label className="space-y-2">
                ...
                <input className={inputClass} defaultValue={settings.firstName} name="firstName" required />
              </label>
              <label className="space-y-2">
                <span className={labelClass}>Last name</span>
                <input className={inputClass} defaultValue={settings.lastName} name="lastName" required />
              </label>
          ...
          <Card className="border-slate-800 bg-slate-950 p-5">
            <SettingsHeader
              ...
              title="Preferences"
            />
            <form action={updatePreferenceSettings} className="mt-5 space-y-3">
              <Toggle
              ...
              <Toggle
                ...
                description="Receive important account, proof, and repository notifications by email."
                icon={Bell}
